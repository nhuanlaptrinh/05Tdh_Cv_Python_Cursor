# 📱 Hướng Dẫn Chạy Ứng Dụng Website Tự Động Hóa Python
...
```powershell
cd "D:\98. Cursor\01. Web_Ban_Hang\05tdhpython"
```
...
```
http://localhost:8007/device-emulator.html
```
...
**Mobile:**
```
http://localhost:8007/index.html?mobile=1
```
...
### ❌ Lỗi: "Port 8007 đang được sử dụng"
**Giải pháp:**
```powershell
# Tìm và dừng process đang dùng port 8007
...
2. Truy cập: `http://localhost:8007/device-emulator.html`
...
4. Kiểm tra firewall không chặn port 8007
